...
#改个名称
  train_output_path = os.path.join(FLAGS.output_dir, 'w9_train.record')
  val_output_path = os.path.join(FLAGS.output_dir, 'w9_val.record')
